...
| 3 | พี่เก้า | `p'kao` | 30 | Hyrox 8K, วิ่ง 10K sub-45 | Build | Lactate: LT1 10.1 km/h (5:56), LT2 11.3 km/h (5:19) |
...
| `Run-Performance-Backup` | 22:00 | สำรองโปรเจกต์ไป `C:\Backup` (`สำรองข้อมูล.bat`) — **สำเนาเดียวของ `garmin.db`** |
